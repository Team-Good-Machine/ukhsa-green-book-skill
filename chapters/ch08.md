...
![Figure 8.1: Spectrum of severity of allergy symptoms](../figures/ch08-fig8.1.png)
...
![Figure 8.2: Initial management of anaphylaxis (reproduced by kind permission of the Resuscitation Council UK)](../figures/ch08-fig8.2.png)
...
- all patients with suspected anaphylaxis should be referred to an allergy clinic -- see https://bsaci.org for details of clinics

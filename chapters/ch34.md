...
![Figure 1](../figures/ch34-fig1.png)
...
Varitect® CP should be given by slow intravenous infusion (0.1ml/kgBW/hr for the first 10 minutes and then slowly increased to a maximum for 1ml/kgBW/hr for the rest of the infusion). Treatment should be started as soon as possible after exposure, preferably within 96 hours, and no longer than 10 days after exposure.
